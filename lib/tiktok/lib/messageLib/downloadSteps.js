...
async function downloadSteps(step, array, index) {
    ...
    switch (step) {
        case 1: // Video Data
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently extracting the video data...`);
            break;
        case 2: // Thumbnail
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently downloading the video thumbnails...`);
            break;
        case 3: // WebP to GIF
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently trying to convert the animated thumbnail to a compatible Discord format...`);
            break;
        case 4: // Video Download
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently downloading the videos...`);
            break;
        case 5: // QC
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently checking the videos to make sure they can be uploaded to Discord correctly...`);
            break;
        case 6: // Video Upload
            ...
            videoDownloadStepsEmbed.setDescription(`Accore is currently uploading the videos to Discord...\nThis could take upto 30 seconds depending on the video size and upload speed.`);
            break;
    }
